...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        // allow Doublejump afeter grounded
        if (isGrounded)
        {
            CanDoublejump = true;
        }
		...
		{
            DoJump();
		}else if (CanDoublejump && Input.GetButtonDown ("Jump")) // if candoublejump and jump button pressed allow doublejump
        {
            DoJump();
            // disable doublejumping after double jumping
            CanDoublejump = false;
